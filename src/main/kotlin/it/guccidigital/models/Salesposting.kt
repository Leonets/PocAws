...
data class Salesposting(val item: String, val size: String, val price: Int, val color: String, val address: String, val cap: String, val destinationCountry: String) {
